...
'falta el nombre': 'falta el nombre',
'falta el tipo': 'falta el tipo',
'falta la cédula': 'falta la cédula',
'falta la direccion': 'falta la direccion',
'faltan los apellidos': 'faltan los apellidos',
'FAQ': 'FAQ',
'Fecha': 'Fecha',
...
'Invitado Por': 'Invitado Por',
'Is Active': 'Está Activo',
'JSON': 'JSON',
'JSON export of visible columns': 'JSON export of visible columns',
'Key': 'Llave',
'La cédula ya existe': 'La cédula ya existe',
'La cédula ya existe + db.asistentes.cedula': 'La cédula ya existe + db.asistentes.cedula',
'La cédula ya existe + db.asistentes.tipo': 'La cédula ya existe + db.asistentes.tipo',
'La cédula ya existe + {{db.asistentes.tipo}}': 'La cédula ya existe + {{db.asistentes.tipo}}',
'La cédula ya existe db.asistentes.tipo': 'La cédula ya existe db.asistentes.tipo',
'La cédula ya existe, tipo.value': 'La cédula ya existe, tipo.value',
'La cédula ya existe??': 'La cédula ya existe??',
'La cédula ya existe{{db.asistentes.tipo}}': 'La cédula ya existe{{db.asistentes.tipo}}',
...
'not in': 'no en',
'Numero': 'Numero',
'número fuera del rango': 'número fuera del rango',
...
'palabra a mostrar': 'palabra a mostrar',
'Password': 'Contraseña',
...
'register': 'regístrese',
'Register': 'Regístrese',
'Registrar Habitantes': 'Registrar Habitantes',
'Registrar Habitantes0': 'Registrar Habitantes0',
'Registrar invitados': 'Registrar invitados',
